<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_create.aspx.cs" Inherits="admin_Admin_create" %>
...
<body>
    ...
    <table class="forminfo">
        <tr><td>用户名</td><td><asp:TextBox ID="username" runat="server" class="dfinput"></asp:TextBox></td><td>
            &nbsp;</td></tr>
