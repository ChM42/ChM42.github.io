            ...
            <table class="table table-bordered table-hover">
                ...
                <asp:Repeater ID="Repeater1" runat="server">
                    ...
                    <ItemTemplate>
                        <tr>
                            <td></td>
                        <td class="text-center"><input type="checkbox" class="qx" name='ckbName' value='<%#Eval("user_id")%>' /></td>
                        <td class="cell-small text-center"><%#Eval("user_id")%></td>
                        <td><a href="javascript:void(0)"><%#Eval("user_name")%></a></td>
                        <td><%#Eval("user_user")%></td>
                        <td><%#Eval("user_sex")%></td>
