<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Meet.aspx.cs" Inherits="admin_Meet" %>
            ...
            <table class="table table-bordered table-hover">
                ...
                <asp:Repeater ID="Repeater1" runat="server">
                    ...
                    <ItemTemplate>
                        <tr>
                            <td></td>
                        <td class="text-center"><input type="checkbox" class="qx" name='ckbName' value='<%#Eval("meet_id")%>' /></td>
                        <td class="cell-small text-center"><%#Eval("meet_id")%></td>
                        <td><a href="javascript:void(0)"><%#Eval("meet_title")%></a></td>
                        <td>原窗口</td>
                        <td><%#Eval("meet_cnt")%></td>
                        <td><%#Eval("meet_time")%></td>
