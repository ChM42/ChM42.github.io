<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Users_update.aspx.cs" Inherits="admin_Users_update" %>
...
<body>
    ...
    <table class="forminfo">
        <tr><td>用户名</td><td><asp:TextBox ID="useruser" runat="server" class="dfinput" Enabled="False"></asp:TextBox></td><td>
            &nbsp;</td></tr>
        <tr><td>姓名</td><td><asp:TextBox ID="username" runat="server" class="dfinput" Enabled="False"></asp:TextBox></td><td>
            &nbsp;</td></tr>
        <tr><td>性别</td><td><asp:TextBox ID="usersex" runat="server" class="dfinput" Enabled="False"></asp:TextBox></td><td>
            &nbsp;</td></tr>
    </table>
